...
//   const [Shoeize, setShoeize] = useState("");
...
//       } else {
//         newProduct = { name, price, brand, Shoeize, shoeColor, gender };
//       }
...
//                 />
//               </label>
//               <label htmlFor={"Shoeize"} style={{ marginRight: "0.5rem" }}>
//                 <div>Shoe size</div>
//                 <input
//                   value={Shoeize}
//                   name={"Shoeize"}
